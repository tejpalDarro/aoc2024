...
public class Day8_part2 {
    ...
    public static void foo(List<List<String>> list, String coord1, String coord2, String obj) {
        ...
        while (valid(newX1, newY1, list.get(0).size(), list.size(), list)) {
        ...
        while (valid(newX2, newY2, list.get(0).size(), list.size(), list)) {
